...
// -------------------------
// Read session token via single-use temporary code (?code=CODE)
// -------------------------
// Phase 3: Direct token params (?s=, ?session=, ?sessionToken=) removed.
// All connections must use temp codes generated by refresh_sse_code.php.
$session_token = '';
